...
load(['data/calca_908-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_911-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_912-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_924-pairing.mat']')
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_927-pairing.mat']')
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_929-pairing.mat']')
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_930-pairing.mat']')
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_933-pairing.mat']')
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);
...
save(['data/cgrp-chrmine-pairing-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end},'.mat'],'data','-v7.3')
%% heatmap
close all
...
h.Box = 'on';
hold off
saveas(gcf,['plots-png/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'epsc')
...
writetable(tbl,'Z:\Chris\matlab\cz\cta-source-data\Fig-ED9c.csv')

saveas(gcf,['plots-png/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'epsc')
...
ylabel('Spiking (σ)')
hold off
saveas(gcf,['plots-png/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-2b-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-2b-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'epsc')
...
writetable(tbl,'Z:\Chris\matlab\cz\cta-source-data\Fig-ED9d.csv')

saveas(gcf,['plots-png/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'epsc')
%% summary plot - PCA

mice = {'calca_908','calca_911','calca_912','calca_924'};
cmap = struct;
figure('Position', get(0, 'Screensize'))
...
saveas(gcf,['plots-png/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-8-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/CGRP-chrmine-pairing/CGRP-chrmine-pairing-plot-8-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',num2str(FDR*100),'pctFDR-',unittype{end}],'epsc')