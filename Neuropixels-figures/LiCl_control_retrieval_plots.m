...
load(['data/calca_461-retrieval.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_462-retrieval.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_463-retrieval.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_913-retrieval.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);
...
save(['data/LiCl-retrieval-GFP-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end},'.mat'],'data','-v7.3')
%% heatmap
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-3-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-3-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-4-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-4-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-6-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-6-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-7-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-7-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-8-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-8-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-9-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-9-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-10-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-10-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
%% PCA plots v2
cmap = struct;
...
saveas(gcf,['plots-png/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-11-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-retrieval-GFP/LiCl-retrieval-GFP-plot-11-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')