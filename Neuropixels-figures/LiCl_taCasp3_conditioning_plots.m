...
data_in = cell(0,0);
load(['data/calca_903-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_905-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_906-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);

load(['data/calca_907-pairing.mat'])
data_in{end+1} = data;
library.all = unique([library.all,data_in{end}.meta.location]);
...
%             data.psth.full.novel(end+1,:,:) = nan(1,30,2000);
%             data.psth.full.water(end+1,:,:) = nan(1,30,2000);
%             data.psth.full.novel(end,1:size(data_in{i}.psth.full.novel(j,:,:),2),:) = data_in{i}.psth.full.novel(j,:,:);
%             data.psth.full.water(end,1:size(data_in{i}.psth.full.novel(j,:,:),2),:) = data_in{i}.psth.full.water(j,:,:);
...
save(['data/LiCl-pairing-taCasp3-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end},'.mat'],'data','-v7.3')
%% heatmap
close all
...
pl1 = [A1(:,501:2000);nan(6,1500);B1(:,501:2000);nan(6,1500);C1(:,501:2000)];
pl2 = [A2(:,501:2000);nan(6,1500);B2(:,501:2000);nan(6,1500);C2(:,501:2000)];
...
pl2 = [A5;nan(6,75);B5;nan(6,75);C5];
subplot(2,2,2)
hold on
...
saveas(gcf,['plots-png/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-1-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
return
%% save table
idx = find(data.stats.significant & data.stats.preference>0);
...
writetable(tbl,'Z:\Chris\matlab\cz\cta-source-data\Fig-3q.csv')
%%
figure('Position', get(0, 'Screensize'))
...
ylabel('Spiking (σ)')
hold off
saveas(gcf,['plots-png/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-2-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-3-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-3-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-4-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-4-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')
...
saveas(gcf,['plots-png/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'png')
set(gcf,'renderer','Painters')
saveas(gcf,['plots-eps/LiCl-pairing-taCasp3/LiCl-pairing-taCasp3-plot-5-',regions,'-',num2str(min_amp),'uV-',num2str(window(2)),'sec-',unittype{end}],'epsc')