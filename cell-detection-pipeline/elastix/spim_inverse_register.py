...
import sys,os
sys.path.append("/jukebox/YOUR_DIR/BrainPipe")
...
if __name__ == '__main__':
	...
	param_fld = "/jukebox/YOUR_DIR/BrainPipe/parameterfolder"
	if atlas == 'Princeton':
		# Princeton Mouse Atlas
		atl = "/jukebox/YOUR_DIR/clearmap-output/utilities/princeton-atlas/sagittal_atlas_20um_iso.tif"
	elif atlas == 'Allen':
		# Allen Mouse Brain Atlas
		atl = "/jukebox/YOUR_DIR/lightsheet-pipeline/allen-atlas-cz/average_template_25_sagittal_forDVscans_cz.tif"
	else:
