...
# ./clearmap_postcellfinder.sh $request_name $imaging_request $sample_name
# ./clearmap_postcellfinder.sh zimmerman_01 1 111
...
atlas=${atlas} clearmap/slurm_scripts/postcellfinder.sh)
