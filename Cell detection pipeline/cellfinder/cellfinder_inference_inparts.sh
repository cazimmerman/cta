...
#SBATCH --job-name=cellfinder_inference_inparts
...
#SBATCH --output=cellfinder/logs/%u_%x_%j.out
...
output_dir="/jukebox/YOUR_DIR/clearmap-output/cellfinder/$request_name/$request_name-$sample_name-pt$part_num/"
cell_candidates="/jukebox/YOUR_DIR/clearmap-output/$request_name/$request_name-$sample_name/$imaging_request/rawdata/resolution_3.6x/cells_raw_filtered_pt$part_num.xml"
