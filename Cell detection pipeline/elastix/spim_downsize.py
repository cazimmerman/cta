...
if __name__ == "__main__":
	...
	if atlas == 'Princeton':
		...
		atlpth = "/jukebox/YOUR_DIR/clearmap-output/utilities/princeton-atlas/sagittal_atlas_20um_iso.tif"
	elif atlas == 'Allen':
		# Allen Mouse Brain Atlas
		atlpth = "/jukebox/YOUR_DIR/lightsheet-pipeline/modified-atlas/average_template_25_sagittal_forDVscans_cz.tif"
	else:
